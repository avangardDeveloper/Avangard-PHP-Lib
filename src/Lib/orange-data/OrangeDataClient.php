...
class OrangeDataClient
{
    ...
    public function send_order()
    {
        ...
        switch ($info['http_code']) {
            case '201':
                $return = ['result' => true, 'code' => $info['http_code'], 'answer' => $answer];
                break;
//            case '401':
...
//                break;
            default:
                $return = ['result' => false, 'code' => $info['http_code'], 'error' => curl_error($curl), 'answer' => $answer];
                break;
        }
//        if (FALSE === $return) {
...
//        }
    ...
    {
        $curl = $this->prepare_curl($this->api_url . '/api/v2/');
