...
class CreateDocumentRequest extends BaseServiceRequest
{
    ...
    /** @var AtolV4ReceiptPosition[] Позиции в чеке */
     ...
     * @param AtolV4ReceiptPosition $position
     * @return CreateDocumentRequest
     */
    public function addReceiptPosition(AtolV4ReceiptPosition $position)
    {
