...
use Box\AtolonlineV4;
use Box\BaseBox;

class AtolV4Auth extends BaseAuth implements GenerateBoxAuth
{
    /**
    ...
    )
    {
        parent::__construct(
            BaseBox::ATOL_V4,
            new AtolV4Company($sno, $vat, $groupCode, $inn, $payment_address),
            $payment_object,
            $payment_method,
            $testMode
        );
    ...
    public static function getAuthParams()
    {
        return [
            'box' => [
                'type' => BaseBox::ATOL_V4,
                'name' => 'АТОЛ Онлайн ФФД 1.05',
            ],
            'login' => [
